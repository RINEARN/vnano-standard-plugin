...
public class AllPatternXvci1Plugin implements ExternalVariableConnectorInterface1 {

	@Override
	public String getVariableName() { return "ALL_PATTERN"; }
	@Override
	...
	public Object getData() throws ConnectorException {
		return (Long)TextModeConstants.ALL_PATTERN;
	}
