...
public class FirstPatternXvci1Plugin implements ExternalVariableConnectorInterface1 {

	@Override
	public String getVariableName() { return "FIRST_PATTERN"; }
	@Override
	...
	public Object getData() throws ConnectorException {
		return (Long)TextModeConstants.FIRST_PATTERN;
	}
