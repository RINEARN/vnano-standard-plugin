...
public class EndXvci1PluginTest {
	...
	@Test
	public void test() {
		ExternalVariableConnectorInterface1 variable = new EndXvci1Plugin();

		// Check variable name
		// 変数名を検査
		assertEquals("END", variable.getVariableName());
		...
		try {
			...
			assertEquals(Long.valueOf(TextModeConstants.END), value);
