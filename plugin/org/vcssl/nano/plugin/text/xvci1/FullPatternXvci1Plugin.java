...
public class FullPatternXvci1Plugin implements ExternalVariableConnectorInterface1 {

	@Override
	public String getVariableName() { return "FULL_PATTERN"; }
	@Override
	...
	public Object getData() throws ConnectorException {
		return (Long)TextModeConstants.FULL_PATTERN;
	}
