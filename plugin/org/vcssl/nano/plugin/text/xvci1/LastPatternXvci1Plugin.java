...
public class LastPatternXvci1Plugin implements ExternalVariableConnectorInterface1 {

	@Override
	public String getVariableName() { return "LAST_PATTERN"; }
	@Override
	...
	public Object getData() throws ConnectorException {
		return (Long)TextModeConstants.LAST_PATTERN;
	}
